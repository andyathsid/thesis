...
Metode ini dipilih karena kesesuaiannya dengan karakteristik penelitian ini yang berfokus pada pengembangan prototipe sistem agentik. Pendekatan D\&D menyediakan kerangka kerja yang terstruktur untuk memandu proses teknis mulai dari konseptualisasi hingga validasi sistem. Hal ini dinilai relevan mengingat luaran penelitian masih terbatas dalam bentuk prototipe yang berhenti pada tahap validasi fungsional dan kinerja, sehingga diperlukan metodologi yang menekankan pada iterasi desain dan pembuktian konsep (\textit{proof of concept}). Tahapan pelaksanaan penelitian mengacu pada enam fase dalam model D\&D, yaitu: (1) identifikasi masalah, (2) deskripsi tujuan, (3) perancangan dan pengembangan, (4) pengujian, (5) evaluasi, dan (6) penyampaian hasil. Alur tahapan tersebut divisualisasikan pada Gambar \ref{fig:dnd}.
...
Identifikasi masalah dalam penelitian ini berawal dari tantangan nyata yang dihadapi dalam diagnosis penyakit tanaman di lapangan. Ketergantungan pada tenaga ahli patologi tumbuhan yang jumlahnya terbatas menyebabkan akses terhadap diagnosis yang akurat menjadi sulit bagi sebagian besar petani dan praktisi pertanian. Di sisi lain, metode pengamatan visual secara manual bersifat subjektif dan rentan terhadap kesalahan, khususnya ketika menghadapi gejala penyakit yang memiliki kemiripan karakteristik visual antarjenis. Meskipun teknologi kecerdasan buatan, khususnya \textit{computer vision}, telah diterapkan untuk otomasi deteksi, solusi yang ada seringkali hanya menghasilkan label klasifikasi sederhana tanpa disertai penjelasan kausalitas atau konteks yang mendalam. Hal ini menciptakan kesenjangan informasi yang menghambat pengguna dalam memahami kondisi tanaman dan mengambil tindakan pengendalian yang tepat.

Untuk mengatasi permasalahan tersebut, dibutuhkan suatu sistem yang tidak hanya memiliki kemampuan persepsi visual untuk lokalisasi dan identifikasi penyakit, tetapi juga kemampuan kognitif untuk memberikan penjelasan yang argumentatif dan berbasis bukti. Penelitian ini mengusulkan pendekatan sistem agentik multimodal yang mengintegrasikan model deteksi objek mutakhir seperti YOLOv11 dan OWLv2 dengan agen LLM yang diperkuat oleh mekanisme \textit{Retrieval-Augmented Generation} (RAG). Integrasi ini bertujuan untuk menghadirkan asisten cerdas yang mampu melakukan diagnosis penyakit tanaman secara interaktif, akurat, dan transparan. Dalam merealisasikan sistem dengan kompleksitas tersebut, diperlukan dukungan infrastruktur komputasi dan perangkat lunak yang spesifik. Rincian perangkat keras dan perangkat lunak yang digunakan untuk mendukung seluruh tahapan penelitian ini dirangkum pada Tabel \ref{tab:perangkat_pendukung}.
